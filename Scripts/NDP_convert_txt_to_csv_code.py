...
remove_extras = ["திருச்சிற்றம்பலம்", "இத்தலம்", "சுவாமிபெயர்","உள்ளுறை அட்டவணைக்குத் திரும்ப","ஓதியருளியது"] 
...
print(f" Processing complete! Cleaned file saved at: {output_file}")
